# Cumulative CO₂ emissions by world region - Data package

This data package contains the data that powers the chart ["Cumulative CO₂ emissions by world region"](https://ourworldindata.org/grapher/cumulative-co2-emissions-region?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on March 01, 2026.
...
Total cumulative emissions of carbon dioxide (CO₂), excluding land-use change, since the first year of available data, measured in tonnes.
...
#### Full citation
Global Carbon Budget (2025) – with major processing by Our World in Data. “Cumulative CO₂ emissions” [dataset]. Global Carbon Project, “Global Carbon Budget v15” [original data].
